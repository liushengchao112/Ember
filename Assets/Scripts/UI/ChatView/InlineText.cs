...
public class InlineText : Text, IPointerClickHandler
{
	...
	//private string expressionPath = "UITexture/Avatar_icon/EmberAvatar_"; //TODO   this is test  path， 
	...
	protected void UpdateQuadImage()
	{
		...
		foreach ( Match match in s_ImageRegex.Matches(m_OutputText) )
		{
			...
			{
				GameResourceLoadManager.GetInstance().LoadAtlasSprite( "EmberAvatar_" + spriteName, delegate( string name, AtlasSprite atlasSprite, System.Object param )
				{
					if ( atlasSprite != null ) {
						
						img.SetSprite( atlasSprite);
					}
				}, true );
			}
